...
namespace RocketElevatorsCustomerPortal.Controllers
{
    public class ProductController : Controller
    {
        ...
        public ProductController(armanadibiContext context, UserManager<RocketElevatorsCustomerPortalUser> userManager, ILogger<HomeController> logger, IFlashMessage flashMessage)
        {
