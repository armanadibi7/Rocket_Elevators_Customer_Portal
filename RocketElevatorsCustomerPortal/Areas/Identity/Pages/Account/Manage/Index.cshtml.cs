...
namespace RocketElevatorsCustomerPortal.Areas.Identity.Pages.Account.Manage
{
    public partial class IndexModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            HttpResponseMessage response = await client.GetAsync("https://rocket-elevators-rest-api.azurewebsites.net/address/" + user.Email + "/phone");
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            var client = new HttpClient();
            HttpResponseMessage response = await client.GetAsync("https://rocket-elevators-rest-api.azurewebsites.net/address/" + user.Email +"/" +Input.PhoneNumber);
